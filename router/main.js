...
const account = '0x8eeB3d83fb8514AAC1De925AE1Aaf95cE65EaDb3'
...
const privateKey = Buffer.from('cf7373d3c0fe154069ec1f432cb4bce50c4adaf04f949619103df6f87731c12e', 'hex')
const contractAddress = '0x744dB7050EffC2A9460Ef62c3bbD6B25fB370427'
...
module.exports = function (app) {
    ...
    app.post('/submit', function (req, res) {
        ...
        const number = req.body.totalnumber;
        const wantnum = req.body.wantnumber;
        console.log('number : ' + number + ", " + wantnum );

        const contractFunction = contract.methods.random(number, wantnum)
